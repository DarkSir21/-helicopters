...
Container.prototype = Object.assign(_Node2.default.prototype);
...
Container.prototype.walk = function walk(filter, cb) {
  var callback = typeof filter === 'function' ? filter : cb;
  var filterReg = filter instanceof RegExp ? filter : new RegExp(filter);

  for (var i = 0; i < this.nodes.length; i++) {
    var node = this.nodes[i];
    var filtered = !cb ? true : filterReg.test(node.type);
